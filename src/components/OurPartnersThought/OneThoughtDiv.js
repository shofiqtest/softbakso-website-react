      ...
      <div className="row">
        {isMobile ? (
          <div className="col-xs-10 col-xs-offset-1 rectangle">
            ...
            <p className="bioFont">{bloggerBio}</p>
            <div className="col-xs-12">
              <p className="processFont tabText">{blogDetails}</p>
            </div>
          </div>
        ) : (
          <div className="col-lg-7 col-lg-offset-3 col-md-9 col-md-offset-2 col-sm-9 col-sm-offset-1 blog">
