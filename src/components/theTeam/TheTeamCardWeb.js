...
// const TheTeamCardWeb = ({property,currentIndex,lastIndex,nextButtonPress,previousButtonPress}) => {
//     const {index, picture,teamMemberName,designation,city} = property;
class TheTeamCardWeb extends React.Component {
...
TheTeamCardWeb.propTypes = {
    // import PropTypes from 'prop-types'; // ES6
    property: PropTypes.object.isRequired,
    // lastIndex:PropTypes.number.isRequired,
};

export default TheTeamCardWeb;