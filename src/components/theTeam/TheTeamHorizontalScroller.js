...
import TheTeamCard from './TheTeamCard';
...
let allEmployeeData = [...data.properties,
    ...data.properties,
    ...data.properties,
    ...data.properties,
    ...data.properties,
    ...data.properties ];
class TheTeamHorizontalScroller extends Component {
                    ...
                    <div>
                        <div className="wrapper-ThreeDivs">
                            <div className="left-ofThreeDivs">
                                ...
                                <img className="sliderMove-iconStyle-img-web"
                            ...
                            <div
                                className="middle-ofThreeDivs">
                                <div className="theTeam_col">

                                    <div className={`theTeam_cards-slider active-slide-${oneEmployee.index}`}>

                                        <div className="theTeam_cards-slider-wrapper" style={{
                                            'transform': `translateX(-${oneEmployee.index * (100 / allEmployees.length)}%)`
                                        }}
                                        >
                                            {
                                                allEmployees.map((
...
// export default  withSizes(mapSizesToProps)(TheTeamHorizontalScroller)
export default  TheTeamHorizontalScroller;
