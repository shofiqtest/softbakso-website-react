        ...
        return (
            <div className="row" id={'blog'}>
                <div className="blogDiv">
                    ...
                    {
                        // this.state.blogList.map((oneThought, index) =>
                        <OneThoughtDiv
                    ...
                    {/*{*/}
                    {/*allThoughts.map((oneThought, index) =>*/}
                    {/*<OneBubbleAT_Thoughts*/}
                    {/*currentIndex={index}*/}
                    {/*key={index.toString()}*/}
                    ...
                    <div className="row ">
                        ...
                        {/*<div className="col-lg-2 col-lg-offset-6 col-md-3 col-md-offset-6*/}
                         {/*col-sm-4 col-sm-offset-6 col-xs-6 col-xs-offset-4 pageDiv">*/}
                        <div className="col-lg-2 col-lg-offset-6 col-md-3 col-md-offset-6
                         col-sm-4 col-sm-offset-6 col-xs-6 col-xs-offset-3 pageDiv">
                            {/*<div className="col-lg-4 col-md-3 col-sm-4 col-xs-4">*/}
